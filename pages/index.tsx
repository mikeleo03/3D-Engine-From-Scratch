      ...
      <div className="sidebar left-sidebar w-[90%] bg-gray-800 text-white p-4 " style={{ flex: 1, margin: 10 }}>
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-col space-y-2">
            <button className="px-2 py-1 bg-white text-gray-800 border border-gray-300 rounded shadow hover:bg-gray-100">Load</button>
            <button className="px-2 py-1 bg-white text-gray-800 border border-gray-300 rounded shadow hover:bg-gray-100">Save</button>
            <button className="px-2 py-1 bg-red-500 rounded shadow hover:bg-red-700">Reset</button>
          </div>
        </div>
      </div>
