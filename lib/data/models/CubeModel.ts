...
export class CubeModel extends Model {
    ...
    private getCube(): SceneNode {
        ...
        const cubeMaterial = new PhongMaterial({ name: "cube", ambientColor: new Color(1 * 255, 0.5 * 255, 0.31 * 255), diffuseColor: new Color(1 * 255, 0.5 * 255, 0.31 * 255), specularColor: new Color(0.5 * 255, 0.5 * 255, 0.5 * 255), shininess: 32});
        const cubeMesh = meshFactory.cuboid(80, 80, 80, [cubeMaterial]);
