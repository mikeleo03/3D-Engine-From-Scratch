...
|-|-|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-|-|
|13521108|Michael Leon Putra Widhi| *Color; Orthographic and Perspective Camera; Lights (including directional and point light); Material (Basic and Phong Material); Shaders (fragment and vertex shader); Diffuse and Specular Textures; Frontend App; UI Intgration*                                                                                                                                                                                           |LeonModel|HollowLeonModel|
